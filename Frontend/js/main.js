        ...
        <div style="margin-bottom: 20px;">
            ...
            <div style="color: var(--tg-theme-text-color, #000000); max-height: 60vh; overflow-y: auto; padding-right: 8px;">
                <div style="margin-bottom: 16px;">
                    ...
                    <strong>❓ Что такое TCatalog?</strong><br>
                ...
                <div style="margin-bottom: 16px;">
                    ...
                    ✅ Перейдите в "Настройки" → "Уведомления" для настройки ежедневных напоминаний.<br><br>
