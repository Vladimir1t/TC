...
const SURVEY_TOPICS = {
    'IT, наука и технологии': {
        icon: '💻',
        value: 'IT',
        subTopics: ['Программирование', 'Нейросети и ИИ', 'Космос', 'Кибербезопасность', 'гаджеты', 'Наука']
    },
    'Бизнес и финансы': {
        icon: '💼',
    ...
    'Образование': {
        icon: '📚',
        value: 'Образование',
        subTopics: ['Книги и литература', 'Наука', 'Познавательные', 'Курсы']
    },
    'Лайфстайл': {
        icon: '✨',
        value: 'Лайфстайл',
        subTopics: ['Психология', 'Красота и мода', 'Здоровье', 'Отношения', 'Бьюти']
    },
    'Путешествия': {
        icon: '✈️',
        value: 'Путешествия',
    ...
    'Медиа, Юмор и Влоги': {
        icon: '🎬',
        value: 'Юмор и Влоги',
        subTopics: ['Влоги', 'Мемы', 'Бьюти', 'Игры', 'Фильмы и сериалы', 'Музыка',]
    },
    'Авто/мото': {
        icon: '🚗',
        value: 'Авто и мото',
    ...
    'Дом и семья': {
        icon: '🏡',
        value: 'Дом и семья',
        subTopics: ['Искусство', 'Дизайн', 'Кулинария', 'Животные', 'Отношения', 'Психолгия']
    },
    'Новости/политика': {
        icon: '📰',
        value: 'Новости',
        subTopics: ['Политика', 'Региональные', 'Экономика', 'История']
    },
    'Хобби и творчество': {
        icon: '⭐️',
        value: 'Юмор и Влоги',
        subTopics: ['Музыка', 'Искусство', 'Рисование', 'Спорт', 'Книги', 'Игры', 'Фильмы']
    },
    'Города/Региональное': {
        icon: '🌍',
        value: 'Города/Региональное',
        subTopics: ['Cпб', 'Москва', 'Екатеринбург', 'Казань', 'Краснодар', 'Челябинск', 'Нижний Новгород']
    },
};
